            ...
            <div>
                ...
                <div className='md:mt-24'>
                    ...
                    <p className=" py-2 w-[85%] mx-auto md:text-base text-sm">
                        Welcome to Ackrolix Innovations. These terms and conditions define the rules
                        and regulations for using our website and Ackrolix Innovations&#39; services.
                ...
                <div className='md:mt-10'>
                    ...
                    <p className=" py-2 w-[85%] mx-auto md:text-base text-sm">
                        Ackrolix is committed to providing high-quality services and
                ...
                <div className='md:mt-10'>
                    ...
                    <p className=" py-2 w-[85%] mx-auto md:text-base text-sm">
                        Ackrolix Innovations and/or its licensors hold the intellectual property rights to
