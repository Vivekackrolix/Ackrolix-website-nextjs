...
const Clients = () => {
  ...
  return (
    <div className="container-ack md:px-0 px-5 md:pt-0 pt-16">
      <div className="md:grid grid-cols-5 items-center hidden ">
      <div className="relative col-span-3">
          <div className="text-[10rem] text-white tracking-wider text-center texttransparent font-bold  md:pt-10 ">
          Clients
          </div>
          <div className="absolute top-[9.2rem] left-[3rem]">
            <div className="text-3xl  text-center font-bold  w-[70%]">Our Satisfied Clients</div>
          </div>
        </div>
