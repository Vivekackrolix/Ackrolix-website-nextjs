...
const data = [
    {
      id: "1",
      src: "/assets/images/blog/blogthree.png",
      date: "22 March 2023",
      head: " Lorem ipsum dolor sit amet in maecenas tinc",
      para: " Lorem ipsum dolor sit amet consectetur. Sapien porttitor non ultrices id enim lectus sagittis viverra interdum. Nisi lobortis tincidunt convallis viverra. Scelerisque sed orci amet proin cras quam pellentesque. Sollicitudin sed velit nunc nunc morbi sed aliquam.",
    },
    {
      id: "2",
      src: "/assets/images/blog/blogthree.png",
...
const Bloglist = () => {
  return (
    <div className="container-ack md:py-12 md:px-0 px-5">
        ...
        {data.map((item, e) => (
          ...
          >
            ...
            <div className="pt-5">
              ...
              <h2 className="font-semibold text-base py-3 text-secondary text-left">
                {item.head}
              </h2>
              <div className=" w-full text-sm text-textcolor group-hover:text-secondary text-justify font-text  pb-4">
                {item.para}
              </div>
              <div className="pb-5 flex justify-between">
                <button className="text-black  pt-2 text-sm  border-primary border-b-2">
                  Read More
                </button>
