        ...
        <div>
          ...
          >
            ...
            <li
              ...
              "
            >
              <p className="group-hover:text-[#edb00a] flex items-center justify-center">Services  <span>
                <BsChevronDown
            ...
            >
              ...
              <Link href="/technology">
                <p className="group-hover:text-[#edb00a] flex items-center justify-center">Technologies  <span>
                  <BsChevronDown
                    className="text-black group-hover:text-[#edb00a]"
                    size={14}
                  />
