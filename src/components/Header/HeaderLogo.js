...
const HeaderLogo = () => {
  return (
    <div className=" md:grid grid-cols-12 gap-3 items-center justify-between pt-5  hidden">
      <div className="col-span-3">
        <Link href="/">
          <div>
            <img src="/assets/images/acklogo.png" className="w-44 h-16" />
          </div>
        </Link>
      </div>
      ...
      <div className="col-span-5 grid grid-cols-2 gap-2 items-center">
